...
test('convert matching double-quotes to single-quotes but do not touch escaped backslashes', t => {
	t.is(fn(fs.readFileSync('fixtures/dont-touch-escaped-backslashes/fixture.txt', 'utf8')), fs.readFileSync('fixtures/dont-touch-escaped-backslashes/expected.txt', 'utf8'));
});
